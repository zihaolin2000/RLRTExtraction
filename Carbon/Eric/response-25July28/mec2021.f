...
! assume contribution is purely transverse
      ...
      real*8 Y,Y2,a1,a2,b1,b2,c1,c2,t1,t2,dw2,xmax,q20,w2min
      real*8 ex,nuel,cof,x,f1mec, f1mec2, xvalm(100)
...
c      a2 = 0.0
       ...
       Y = A**1.0*(q2+q20)**xvalm(2)
     &     /(xvalm(3)+q2)**xvalm(4) 

c       Y2 = Y
c       Y2 = Y*(q2+q20)**xvalm(19)/(q2+q20)**2
      Y2 =  A**1.0*(q2+q20)**xvalm(19)
     &     /(xvalm(20)+q2)**4
      Y2 = Y2/(1.0+0.5*sqrt(q2))
...
c      c1 = 0.1469+0.0*q2
      ...
      f1mec2 = Y2*exp(-1.*t2)
c      f1mec2 = f1mec2*(dw2)**1.5  
      
c      f1mec2 = f1mec2/(q2+q20)**0.5
      
      f1mec = a1*f1mec+a2*f1mec2
