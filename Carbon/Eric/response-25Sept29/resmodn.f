...
CCC  Version from Feb 23, 2025  -  Author:  M.E. Christy                    CCC
...
CCC  replaced 2-pi threshold with eta                                       CCC
      ...
      q20 = 0.05
c      q20 = xval(50)
      q20 = xval(50)*sqrt(1.0+0.25*q20/(q20+q2))
...
c      if(sf.EQ.2) x0(1) = 0.07   !!!  different Delta mass for sigL
      ...
      dip = 1./(1.+q2/0.85)**2.0   !!!  Dipole parameterization  !!!
      mon = 1./(1.+q2/1.5)**1.0
...
CCC    Begin resonance Q^2 dependence calculations   CCC
     ...
     &          mon**rescoef(i,4)
          ...
          if(i.LE.7) height(i) = height(i)/(1.0+0.04*q2)
