...
!--------------------------------------------------------------------
      ...
      real*8 xxp(500),fytot,fytot2,norm,bw,nwid,ncor,D1
...
c        t1 = sqrt(t1) 
     ...
     &            (1.0+xvalc(39)*q2**3)) !!! fixed on 11/02/23, mp -> mp2
...
CCC   Next is medium modification factor  CCC
            ...
            emcfac = 1.0-xvalc(12)/a0*abs(1.-xp)**xvalc(15)
c             emcfac = 1.0
             emcfac = xvalc(11)*emcfac/(1.0-xvalc(12)/a0*
     &            abs(1.-xvalc(13))**3)/
     &            (1.0+xvalc(14)*abs(xp-xvalc(13))**1)

             emcfac = emcfac*(1.0+xvalc(16)*(xt-xvalc(13)))

             emcfac = emcfac*(1.0+xvalc(37)*(1.0-xt)**1.5+
     &                     xvalc(38)*(1.0-xt)**2.5)
